...
final class PokedexCell: UICollectionViewCell, ConfigurableCell {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            indexLabel.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: -10.0),
            indexLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -110.0)
        ])

        contentView.addSubview(titleLabel)
        NSLayoutConstraint.activate([
            titleLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor),
            titleLabel.topAnchor.constraint(equalTo: indexLabel.bottomAnchor),
    ...
    override func layoutSubviews() {
		...
		layer.borderColor = UIColor.pokedexRed.cgColor
